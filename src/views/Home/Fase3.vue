    ...
    <template v-else>
      ...
      <v-sheet class="overflow-hidden">
        ...
        <v-container class="fill-height">
          <v-card class="card">
            <v-card-title>Residentes actuales en la Fase 3</v-card-title>
            <v-container>
              <v-row>
                  ...
                  >
                    <v-hover v-slot="{ hover }">
                      <v-card
                        ...
                        max-width="90%"
                        @click.native="abrirProgresoFase3(residente.id)"
        ...
        <v-navigation-drawer v-model="drawer" absolute temporary>
          <v-list-item>
            <v-list-item-content>
              <v-list-item-title>Acerca de la Fase 3</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
