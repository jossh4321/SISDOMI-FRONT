      ...
      listaOpciones: [
        {
          ...
          descripcion:
            "Interfaz de Gestion especializada en el control, seguimineto , investigacion y registro de datos relacionados con los usuarios del CAR",
          interfazUrl: "/dashboard/Tratamiento",
          boton: { texto: "Realizar Tratamiento", icono: "mdi-cloud-upload" },
        },
        {
          id: 2,
          imagenUrl: "https://cdn.vuetifyjs.com/images/cards/sunshine.jpg",
