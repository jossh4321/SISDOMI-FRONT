        ...
        <v-stepper-content step="2">
          <div class="container-user">
            <form>
              ...
              <v-card
                style="margin:5x;margin-bottom:15px;padding:10px; border: 1px solid #b3b3b3;"
              >
                ...
                <v-card
                  style="margin:5px; padding:5px;border:1px solid #b3b3b3; margin-top:1px"
                >
                  <div>
                    <v-chip
              ...
              <v-row>
                <v-col>
                  <v-card
                    style="margin:5px; padding:5px;border:1px solid #b3b3b3;"
                  >
                    <v-row>
                      <v-col>
                        <v-card-subtitle
                          >Imagen del Perfil de
                          {{ usuario.datos.nombre }}</v-card-subtitle
                        >
                      </v-col>
                    </v-row>
                    <v-row>
                ...
                <v-col>
                  ...
                  >
                    <v-row>
                      <v-col>
                        <v-card-subtitle
                          >Firma de {{ usuario.datos.nombre }}</v-card-subtitle
                        >
                      </v-col>
                    </v-row>
                    <v-row>
