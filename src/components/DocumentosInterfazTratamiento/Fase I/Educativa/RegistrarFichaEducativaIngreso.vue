          ...
          <div  class="container-user">
            <form> 
                ...
                <v-card class="subcard">
                          <v-card-title>Datos del Educador</v-card-title>
                          <v-card class="subcard"  style="margin-bottom:7px" color="#e6f3ff">
                              <v-text-field
      ...
      generarPDF(){
        ...
        doc.autoTable({
          ...
          body: [
            ...
            [{ content: '1. Apellidos y Nombres: '+ this.residente.apellido +" "+this.residente.nombre, styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 3} } }],
            [{ content: '2. Lugar y Fecha de Nacimiento: ' + this.residente.lugarnacimiento + " " + this.convertirFechas(this.residente.fechanacimiento), styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 3}} }],
            [{ content: '3. DNI: ' + this.residente.numerodocumento+ '          Edad: '+this.residenteEdad() +' años' +'          Sexo: ' + this.residente.sexo ,styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 3} } }],
            [{ content: '4. Fecha de Ingreso al CAR: '+ this.convertirFechas(this.residente.fechaingreso),styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 3} } }],
            [{ content: '5. Educador Responsable: '+ this.user.datos.nombre + " " + this.user.datos.apellido,styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 3} } }],
            ...
            [{ content: '1. Apellidos y Nombres: '+ this.user.datos.nombre + " " + this.user.datos.apellido, styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 7} } }],
            [{ content: 'DNI: '+ this.user.datos.numerodocumento + '           ' +'Correo Electrónico: '+ this.user.datos.email, styles: { fontStyle:'normal', fontSize: 11 , cellPadding: {left: 11}} }],
