    ...
    async generarPDF(){
        ...
        doc.autoTable({
          ...
          body: [
            ...
            [{ content: '2. Lugar y Fecha de Nacimiento: ' + this.residente.lugarnacimiento + " " + this.convertirFechas(this.residente.fechanacimiento)+"          N.º Expediente: "+ await this.obtenerExpediente(), styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 3}} }],
            ...
            [{ content: '4. Educador Responsable: '+ this.user.datos.nombre + " " + this.user.datos.apellido,styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 3} } }],
