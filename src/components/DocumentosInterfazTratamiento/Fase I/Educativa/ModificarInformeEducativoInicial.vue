  ...
  methods: {    
    ...
    async generarPDF(){
        ...
        doc.autoTable({
          ...
          body: [
            [""],[""],[""],[""],
            [{ content: 'INFORME EDUCATIVO INICIAL',styles: { halign: 'center', fontStyle:'bold', fontSize: 12 } }],
            ...
            [{ content: 'II. DATOS GENERALES: ', styles: { fontStyle:'bold', fontSize: 11 } }],
            ...
            [{ content: '2. Lugar y Fecha de Nacimiento: ' + this.residenteDocumento.lugarnacimiento + " " + this.convertirFechas(this.residenteDocumento.fechanacimiento)+"          N.º Expediente: "+ await this.obtenerExpediente(), styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 3}} }],
            ...
            [{ content: '4. Educador Responsable: '+ this.usua.datos.nombre + " " + this.usua.datos.apellido,styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 3} } }],
            [{ content: '5. Fecha de Evaluación: '+ new Date().toLocaleDateString(),styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 3} } }],
            [{ content: '--------------------------------------------------------------------------------------------------------------------------',styles: { fontStyle:'bold', fontSize: 11 } }],
            [{ content: 'I. SITUACIÓN ACADÉMICA:', styles: { fontStyle:'bold', fontSize: 11 } }],
            [{ content: this.informe.contenido.situacionacademica,styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 7} } }],
            [{ content: 'II. ANALISIS ACADEMICO Y COMPORTAMIENTO:', styles: { fontStyle:'bold', fontSize: 11 } }],
            [{ content: this.informe.contenido.analisisacademico,styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 7} } }],
            [{ content: 'III. CONCLUSIONES/RECOMENDACIONES:', styles: { fontStyle:'bold', fontSize: 11 } }],
            [{ content: this.conclusionesPdf(),styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 7} } }],
          ],
      ...
      conclusionesPdf(){
        var observaciones = "";
        this.informe.contenido.conclusiones.forEach(element => 
