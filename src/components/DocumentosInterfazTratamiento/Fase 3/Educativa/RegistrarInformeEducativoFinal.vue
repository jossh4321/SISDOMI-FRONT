    ...
    <v-card-text>
      <v-stepper v-model="step">
        <v-stepper-header>
          ...
          <v-divider></v-divider>
          <v-stepper-step editable step="2">Análisis y Diagnóstico</v-stepper-step>
        </v-stepper-header>
        <v-stepper-items>
  ...
  methods: {
    ...
    async generarPDF(){
        ...
        doc.autoTable({
          ...
          body: [
            [""],[""],[""],[""],
            [{ content: 'INFORME EDUCATIVO FINAL',styles: { halign: 'center', fontStyle:'bold', fontSize: 12 } }],
            [{ content: 'I. DATOS GENERALES: ', styles: { fontStyle:'bold', fontSize: 11 } }],
            [{ content: 'Apellidos y Nombres: '+ this.residente.apellido +" "+this.residente.nombre, styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 7} } }],
            [{ content: 'Edad: '+this.residenteEdad() +' años'+'          DNI: ' + this.residente.numerodocumento ,styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 7} } }],
            [{ content: 'Lugar y Fecha de Nacimiento: ' + this.residente.lugarnacimiento + " " + this.convertirFechas(this.residente.fechanacimiento), styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 7}} }],
            [{ content: 'Fecha de Ingreso al CAR: '+ this.convertirFechas(this.residente.fechaingreso),styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 7} } }],
            [{ content: 'Juzgado de procedencia: '+this.residente.juzgadoprocedencia+'          Nº de Expediente: ' + await this.obtenerExpediente() ,styles: { fontStyle:'normal', fontSize: 11, cellPadding: {left: 7} } }],
