<template>
<v-card>
    <v-card-title class="justify-center">Modificar Ficha de Evaluacion y Diagnostico Educativo</v-card-title>
                      ...
                      <v-row>
                        ...
                        <v-col>
                          <v-btn block @click="ModificarFichaEvaluacion" color="success">
                            ...
                            <span>Modificar Ficha de Evaluacion Educativa</span>
                          </v-btn>
                        </v-col>
                      </v-row> 
                 </form>
...
export default {
  name:"ActualizarFichaDiagnosticoEducativo",
